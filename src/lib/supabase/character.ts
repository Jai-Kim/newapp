...
/**
 * supabase-js reports any non-2xx as a FunctionsHttpError whose message is just
 * "Edge Function returned a non-2xx status code" — the useful part is the
 * response body, which has to be read off the attached Response.
 */
